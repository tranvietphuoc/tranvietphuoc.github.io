...
**Các vấn đề có thể xảy ra với threading là race conditions, bạn có thể tham khảo [bài viết trước](https://tranvietphuoc.github.io/posts/threading-processing-1.html) hoặc [ví dụ này](https://realpython.com/python-concurrency/#threading-version)**
...
Ở bài viết về [processes](https://tranvietphuoc.github.io/posts/threading-processing-2.html) mình đã trình bày tại sao không nên dùng multiprocessing cho I/O task nên mình sẽ không trình bày ở đây.
